...
TEST_CASE("ptp_timestamp") {
    ...
    SECTION("Add overflow") {
        rav::ptp::ptp_timestamp ts1(1'500'000'000);
        rav::ptp::ptp_timestamp ts2(1'500'000'001);
        auto result = ts1 + ts2;
    ...
    SECTION("Subtract") {
        rav::ptp::ptp_timestamp ts1(2'000'000'002);
        rav::ptp::ptp_timestamp ts2(1'000'000'001);
        auto result = ts1 - ts2;
    ...
    SECTION("Subtract underflow") {
        rav::ptp::ptp_timestamp ts1(2'500'000'001);
        rav::ptp::ptp_timestamp ts2(1'500'000'002);
        auto result = ts1 - ts2;
    ...
    SECTION("Greater than") {
        rav::ptp::ptp_timestamp ts1(1'000'000'002);
        rav::ptp::ptp_timestamp ts2(1'000'000'001);
        REQUIRE(ts1 > ts2);
        REQUIRE_FALSE(ts2 > ts1);
    }
    ...
    SECTION("Add time interval") {
        ...
        SECTION("Add -2.5ns") {
            rav::ptp::ptp_timestamp ts(1'000'000'001);
            rav::ptp::ptp_time_interval ti(0, -3, 0x8000);
        ...
        SECTION("Add -2ns") {
            rav::ptp::ptp_timestamp ts(1'000'000'001);
            rav::ptp::ptp_time_interval ti(0, -2, 0x0000);
            ts.add(ti);
            REQUIRE(ts.raw_seconds() == 0);
        ...
        SECTION("Add -2.49s") {
            rav::ptp::ptp_timestamp ts(3'000'000'000);
    ...
    SECTION("To time interval") {
        rav::ptp::ptp_timestamp ts(3'000'000'001);
    ...
    SECTION("Convert to samples") {
        SECTION("0.5 seconds") {
            rav::ptp::ptp_timestamp ts(500'000'000);
        ...
        SECTION("2 seconds") {
            rav::ptp::ptp_timestamp ts(2'000'000'000);
        ...
        SECTION("2.5 seconds") {
            rav::ptp::ptp_timestamp ts(2'500'000'000);
        ...
        SECTION("330 years 2300 absolute") {
            auto ts = rav::ptp::ptp_timestamp::from_years(330);
        ...
        SECTION("Take lower 32 bits") {
            auto ts = rav::ptp::ptp_timestamp::from_seconds(0x1122334455667788);

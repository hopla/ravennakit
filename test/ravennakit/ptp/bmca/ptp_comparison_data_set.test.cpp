...
TEST_CASE("ptp_comparison_data_set") {
    rav::ptp::ptp_comparison_data_set a;
    ...
    a.grandmaster_clock_quality.clock_accuracy = rav::ptp::ptp_clock_accuracy::lt_10_ns;
    ...
    rav::ptp::ptp_comparison_data_set b = a;  // Start with equal sets

    SECTION("Grandmaster identity is equal") {
        SECTION("Steps removed of a is better") {
            a.steps_removed -= 2;
            REQUIRE(a.compare(b) == rav::ptp::ptp_comparison_data_set::result::better);
        }
        SECTION("Steps removed of a is worse") {
            a.steps_removed += 2;
            REQUIRE(a.compare(b) == rav::ptp::ptp_comparison_data_set::result::worse);
        }
        ...
        SECTION("Steps removed of a is better") {
            ...
            SECTION("Receiver > Sender") {
                ...
                REQUIRE(a.compare(b) == rav::ptp::ptp_comparison_data_set::result::better_by_topology);
            }
        }
        ...
        SECTION("Steps removed of a is worse") {
            ...
            SECTION("Receiver > Sender") {
                ...
                REQUIRE(a.compare(b) == rav::ptp::ptp_comparison_data_set::result::worse_by_topology);
            }
        }
    ...
    SECTION("Grandmaster identity is not equal") {
        ...
        SECTION("GM Clock accuracy of a is better") {
            a.grandmaster_clock_quality.clock_accuracy = rav::ptp::ptp_clock_accuracy::lt_2_5_ns;
            REQUIRE(a.compare(b) == rav::ptp::ptp_comparison_data_set::result::better);
        }

        SECTION("GM Clock accuracy of a is worse") {
            a.grandmaster_clock_quality.clock_accuracy = rav::ptp::ptp_clock_accuracy::lt_25_ns;
            REQUIRE(a.compare(b) == rav::ptp::ptp_comparison_data_set::result::worse);
        }
    ...
    SECTION("Order of ordering") {
        using ordering = rav::ptp::ptp_comparison_data_set::result;

...
TEST_CASE("ptp_announce_message") {
    SECTION("Unpack from data") {
        ...
        auto announce = rav::ptp::ptp_announce_message::from_data({}, rav::buffer_view(data));
        REQUIRE(announce);
        ...
        REQUIRE(announce->grandmaster_clock_quality.clock_accuracy == rav::ptp::ptp_clock_accuracy::lt_25_ns);
        ...
        REQUIRE(announce->time_source == rav::ptp::ptp_time_source::ptp);
    }
}

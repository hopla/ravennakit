...
rav::rtp::rtp_packet_view::rtp_packet_view(const uint8_t* data, const size_t size_bytes) :
    data_(data), size_bytes_(size_bytes) {}

bool rav::rtp::rtp_packet_view::validate() const {
    if (data_ == nullptr) {
        return false;
    }
...
bool rav::rtp::rtp_packet_view::marker_bit() const {
...
uint8_t rav::rtp::rtp_packet_view::payload_type() const {
    // TODO: This check should probably be skipped, assuming validate() is called before calling this method.
    if (size_bytes_ < 1) {
        return false;
    }
...
uint16_t rav::rtp::rtp_packet_view::sequence_number() const {
...
uint32_t rav::rtp::rtp_packet_view::timestamp() const {
...
uint32_t rav::rtp::rtp_packet_view::ssrc() const {
...
uint8_t rav::rtp::rtp_packet_view::version() const {
    // TODO: This check should probably be skipped, assuming validate() is called before calling this method.
    if (size_bytes_ < 1) {
        return 0;
    }
...
bool rav::rtp::rtp_packet_view::padding() const {
    // TODO: This check should probably be skipped, assuming validate() is called before calling this method.
    if (size_bytes_ < 1) {
        return false;
    }
...
bool rav::rtp::rtp_packet_view::extension() const {
    // TODO: This check should probably be skipped, assuming validate() is called before calling this method.
    if (size_bytes_ < 1) {
        return false;
    }
...
uint32_t rav::rtp::rtp_packet_view::csrc_count() const {
    // TODO: This check should probably be skipped, assuming validate() is called before calling this method.
    if (size_bytes_ < 1) {
        return 0;
    }
...
uint32_t rav::rtp::rtp_packet_view::csrc(const uint32_t index) const {
    if (index >= csrc_count()) {
        return 0;
    }
...
uint16_t rav::rtp::rtp_packet_view::get_header_extension_defined_by_profile() const {
    if (!extension()) {
        return 0;
    }
...
rav::buffer_view<const uint8_t> rav::rtp::rtp_packet_view::get_header_extension_data() const {
    if (!extension()) {
        return {};
    }
...
size_t rav::rtp::rtp_packet_view::header_total_length() const {
...
rav::buffer_view<const uint8_t> rav::rtp::rtp_packet_view::payload_data() const {
    if (data_ == nullptr) {
        return {};
    }
...
size_t rav::rtp::rtp_packet_view::size() const {
    return size_bytes_;
}

const uint8_t* rav::rtp::rtp_packet_view::data() const {
    return data_;
}

std::string rav::rtp::rtp_packet_view::to_string() const {
    return fmt::format(

 ...
 */
struct dnssd_service_discovered {
...
class dnssd_browser:
    public events<
        dnssd_service_discovered, dnssd_service_removed, dnssd_service_resolved, dnssd_address_added,
        dnssd_address_removed, dnssd_browse_error> {
  public:
